...
def main():
    parser = argparse.ArgumentParser(argument_default=argparse.SUPPRESS,
                                     description='convert PascalVOC XML annotation to MSCOCO JSON annotation')
    ...
    parser.add_argument('--merge_category', default=False, action="store_true",
                        help='Merge the object class in dataset to category list if not exist')
